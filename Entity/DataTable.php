...
class DataTable
{
    ...
    /**
     *
     * Tipo de parametros, pode ser a��o o acesso
     * 
     * @var array 
     */
     ...
     * ZuniPessoaBundle:Cidade as cidade, o apelido ser� cidade
     * 
     * @var string 
     */
    private $aliasEntity;
    ...
    /**
     *
     * Offset, at� onde ser� mostrada as entidades
     * 
     * @var integer 
     */
    private $length;
    ...
    /**
     * p�gina��o, de onde come�a a mostrar a grid
     * @var integer 
     */
    private $start;
    ...
    /**
     * array que cont�m todos os apelidos de todas as entidades
    ...
    /**
     *
     * Nome do m�todo que cont�m um dql parte, para montar o filtro dql
     * @var string 
     */
    ...
    /**
     * DQL parte, usado para montar o sql que busca a cole��o de entidades
     * @var stirng 
     */
    private $dqlPart;
    ...
    /**
     *
     * DQL parametros, comp�e o DQL parte
     * @var array 
     */
    private $dqlParam;
    ...
    /**
     *
     * Usado para renderizar os m�todos
     * 
    ...
    /**
     * Caminho do arquivo de a��es para renderizar os bot�es da grid
     * 
     * @var string
     */
     ...
     * </code></pre>
     * 
     * @todo Testar quando n�o tiver alias
    ...
    /**
     * Retorna todas as entities que ser�o necessarias para pegar os 
     * valores de gets com nome e apelido 
     * 
     * O M�todo ir� retornar um array com o nome da entity coomo as chaves do array
     * e em cada entity, ter� uma chave alias e outra previous
     * 
    ...
    /**
     * 
     * Valida todoas as classes usadas para ter acesso ao m�todo
     * 
     * 
        ...
        if (!$this->columns) {
            ...
            foreach ($this->getGets() as $key => $get) {
                if ($typeParam[$key] === 'access') {
                    ...
                    //Tem que fazer isso aqui, pois tem filtro twig onde é necessário "." no construtor. Ex: number_format, dai dava mais explode que deveria
     ...
     * @param \Symfony\Bundle\TwigBundle\TwigEngine $twig
     * @param \ArrayObject $collectionEntity Cole��o de entidades
     * @return array
     */
     ...
     * renderizado
     * 
     * @todo Alterar m�todo para n�o testar as variaveis com Twig
...
TWIG;
    ...
    /**
     * 
     * Invoca o m�todo da entidade que possui a dql part
     * 
    ...
    /**
     * 
     * Converte o DQL part passado, para o verdadeira peda�o DQL 
    ...
    /**
     * Retorna uma cole��o de itens com todos os requisitos para o mesmo 
     * order limit ... 
     * @todo Mudar m�todo para o Reposioty de DataTable
     */
